...
namespace SimsTraits
{
    ...
    public static class Titles_Patch
    {
        ...
        {
            yield return AccessTools.Method(typeof(ThoughtWorker_RoyalTitleApparelRequirementNotMet), nameof(ThoughtWorker_RoyalTitleApparelRequirementNotMet.Validate));
            yield return AccessTools.Method(typeof(ThoughtWorker_RoyalTitleApparelMinQualityNotMet), nameof(ThoughtWorker_RoyalTitleApparelMinQualityNotMet.Validate));
            yield return AccessTools.Method(typeof(ThoughtWorker_RoyalTitleApparelRequirementNotMet), nameof(ThoughtWorker_RoyalTitleApparelRequirementNotMet.GetAllRequiredApparelPerGroup));
            yield return AccessTools.Method(typeof(JobGiver_OptimizeApparel), nameof(JobGiver_OptimizeApparel.ApparelScoreRaw));
            yield return AccessTools.Method(typeof(Pawn_RoyaltyTracker), nameof(Pawn_RoyaltyTracker.HighestTitleWithBedroomRequirements));
            yield return AccessTools.Method(typeof(FoodUtility), nameof(FoodUtility.InappropriateForTitle));
            yield return AccessTools.Property(typeof(Pawn_ApparelTracker), "AllRequirements").GetGetMethod(true);
            yield return AccessTools.Property(typeof(Alert_RoyalNoAcceptableFood), "Targets").GetGetMethod(true);
            yield return AccessTools.Method(typeof(Alert_RoyalNoAcceptableFood), nameof(Alert_RoyalNoAcceptableFood.GetExplanation));
