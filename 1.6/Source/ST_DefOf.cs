...
namespace SimsTraits
{
    ...
    public static class ST_DefOf
    {
        ...
        public static TraitDef ST_Submissive, VTE_AbsentMinded, VTE_Vengeful, ST_DrunkenMaster,
            VTE_BigBoned, VTE_Clumsy, VTE_Workaholic, ST_Insomniac, VTE_WorldWeary, TorturedArtist, VTE_AnimalLover;
        ...
        public static ThoughtDef Insulted, Slighted, ST_ParanoidThought, ST_LoyalThought, KindWordsMood, ST_NewStuff, ObservedLayingCorpse, ST_ListenedToVirtuoso;
